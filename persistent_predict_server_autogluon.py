...
def main():
    ...
    print("READY") # DO NOT CHANGE THIS LINE, IT IS USED TO HANDSHAKE BETWEEN THE PREDICT SERVER AND THE CLIENT
    ...
    for line in sys.stdin:
        ...
        print("OK", flush=True) # DO NOT REMOVE: signalisiert dem Client, dass die Vorhersage fertig ist
